        ...
        <div class="dashboard-app">
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="col-md-3 card-bg-glass">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <button class="nav-link" id="v-pills-general-tab" data-bs-toggle="pill" data-bs-target="#v-pills-general" type="button" role="tab" aria-controls="v-pills-general" aria-selected="false">General Info</button>
                            <button class="nav-link" id="v-pills-password-tab" data-bs-toggle="pill" data-bs-target="#v-pills-password" type="button" role="tab" aria-controls="v-pills-password" aria-selected="false">Password & Email</button>
                            <button class="nav-link" id="v-pills-logo-tab" data-bs-toggle="pill" data-bs-target="#v-pills-logo" type="button" role="tab" aria-controls="v-pills-logo" aria-selected="false">Logo Update</button>
                            <button class="nav-link" id="v-pills-receptionist-tab" data-bs-toggle="pill" data-bs-target="#v-pills-receptionist" type="button" role="tab" aria-controls="v-pills-receptionist" aria-selected="false">Receptionist Info</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane card-bg-glass p-2 fade show" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab">
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="companyName" placeholder="Enter company name" value="HosPro">
                                    </div>
                                    <div class="mb-3">
                                        <label for="companyAddress" class="form-label">Address</label>
                                        <input type="text" class="form-control" id="companyAddress" placeholder="Enter company address" value="Ashulia, Savar, Dhaka">
                                    </div>
                                    <div class="mb-3">
                                        <label for="phoneNumber" class="form-label">Phone Number</label>
                                        <input type="text" class="form-control" id="phoneNumber" placeholder="Enter phone number" value="+880 1234567890">
                                    </div>
                            ...
                            <div class="tab-pane card-bg-glass p-2 fade" id="v-pills-password" role="tabpanel" aria-labelledby="v-pills-password-tab">
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="adminEmail" placeholder="Enter new email" value="HosPro24/7@gmail.com">
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="tab-pane card-bg-glass p-2 fade" id="v-pills-receptionist" role="tabpanel" aria-labelledby="v-pills-receptionist-tab">
                                ...
                                <form>
                                    <div class="mb-3">
                                        <label for="receptionistUsername" class="form-label">Receptionist Username</label>
                                        <input type="text" class="form-control" id="receptionistUsername" placeholder="Enter receptionist username">
                                    </div>
                                    <div class="mb-3">
                                        <label for="receptionistPassword" class="form-label">Receptionist Password</label>
                                        <input type="password" class="form-control" id="receptionistPassword" placeholder="Enter receptionist password">
                                    </div>
