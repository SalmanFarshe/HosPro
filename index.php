...
<head>
    ...
    <title>Welcome to HosPro | Hotel Management System</title>
    ...
    <div class="root-page-wrapper">
        <div class="root-page-inner-wrapper">
            <div class="hospro-content-wrapper bg-glass">
                <div class="hospro-inner-left">
                    <img src="./assets/img/Dark-Logo_HosPro.png" alt="" class="hospro-index-logo">    
                    <h1>Welcome Dear</h1>
                    <p>Please Log according to your role!</p>
            ...
            <div class="hospro-devider bg-glass">
            ...
            <div class="hospro-content-wrapper bg-glass">
                <div class="hospro-inner-right">
                    ...
                    <button type="button" class="button">
                        <a href="./pages/admin.php" class="button_link">Admin</a>
                    </button>
                </div>
            </div>     
        </div>
