                ...
                <form method="post" action="install_process.php" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <h5 class="mt-4 mb-3 text-center">Admin Info</h5>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control frm-input" id="receptionist_username" name="receptionist_username" required>
                            </div>
                            <div class="mb-3">
                                <label for="receptionist_password" class="form-label fw-bold frm-label">Receptionist Password</label>
                                <input type="password" class="form-control frm-input" id="receptionist_password" name="receptionist_password" required>
                            </div>
                             <div class="mb-3">
                                <h5 class="mt-5 pt-2 mb-3 text-center">Root Info (Optional)</h5>
                                <label for="admin_password" class="form-label frm-label fw-bold">Database Name</label>
                                <input type="password" class="form-control frm-input" id="admin_password" name="admin_password" required>
                            </div>
                        </div>
                    </div>
